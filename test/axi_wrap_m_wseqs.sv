...
class axi_wrap_m_wseqs #(int ADDR_WIDTH=32, DATA_WIDTH=32) extends axi_base_m_seqs#(ADDR_WIDTH, DATA_WIDTH);
    ...
    //axi_m_seq_item #(ADDR_WIDTH, DATA_WIDTH) rsp; // ADDED: handle for the response
    ...
    task body();
        ...
        repeat(no_of_trans) begin
          ...
          //resp(1);
          //join_none
            // ADDED: Wait for driver to complete B-channel and send put_response
            //get_response(rsp); 
          ...
          //resp(1);
            //join_none
            // ADDED: Wait for driver to complete R-channel and send put_response
            //get_response(rsp);
