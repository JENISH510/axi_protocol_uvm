`ifndef AXI_FIXED_M_WSEQS_SV
`define AXI_FIXED_M_WSEQS_SV

class axi_fixed_m_wseqs #(int ADDR_WIDTH=32, DATA_WIDTH=32) extends axi_base_m_seqs#(ADDR_WIDTH, DATA_WIDTH);

  `uvm_object_param_utils(axi_fixed_m_wseqs#(ADDR_WIDTH, DATA_WIDTH))
