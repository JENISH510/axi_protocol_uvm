...
class axi_fixed_vseqs extends axi_base_vseqs;

  `uvm_object_utils(axi_fixed_vseqs)

    axi_fixed_m_wseqs m_wseqs_h;

    function new(string name="axi_fixed_vseqs");
        super.new(name);
    endfunction
...
class axi_fixed_test extends axi_base_test;
  ...
  function new(string name="axi_fixed_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
        ...
        vseqs_h=axi_fixed_vseqs::type_id::create("vseqs_h");
    endfunction
